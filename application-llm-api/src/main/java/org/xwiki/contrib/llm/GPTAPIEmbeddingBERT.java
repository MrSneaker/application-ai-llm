...
@Component
@Named("org.xwiki.contrib.llm.GPTAPIEmbeddingBERT")
@Unstable
@Singleton
public class GPTAPIEmbeddingBERT extends ModifiablePageResource implements XWikiRestComponent {

    protected Logger logger;

    public String doEmbeddingREST(String data) throws XWikiException, XWikiRestException {
        try {
    ...
    public float[] doEmbedding(String data) throws XWikiException {
